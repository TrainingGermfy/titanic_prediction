...
def home():
    # Age,SibSp,Parch,isfemale,Pclass_First,Pclass_Second,Pclass_Third,Cabin_class_B,Cabin_class_C,Cabin_class_D,
    # Cabin_class_E,Cabin_class_F,Cabin_class_G,Cabin_class_T,Cabin_class_U,Embarked_C,Embarked_Q,Embarked_S,Embarked_U
    ...
    form_class = [0, 0, 0]
    form_embarked = [0, 0, 0, 0]
    form_cabin_class = [0, 0, 0, 0, 0, 0, 0, 0]
    form_class[int(data['inpClase']) - 1] = 1
    form_embarked[int(data['inpEmbarque']) - 1] = 1
    if int(data['inpCabina']) > 0:
        form_cabin_class[int(data['inpCabina']) - 1] = 1

    pasajero = [[form_edad, form_sibSP, form_parch, form_isfemale, form_class[0], form_class[1], form_class[2],
                 ...
                 form_embarked[2], form_embarked[3]]]
    print(pasajero)
